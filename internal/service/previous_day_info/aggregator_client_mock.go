...
//go:generate minimock -i github.com/robertobadjio/tgtime-notifier/internal/service/previous_day_info.aggregatorClient -o aggregator_client_mock.go -n AggregatorClientMock -p previous_day_info
